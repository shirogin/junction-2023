...
export default function UpdateDesk({ desk }: { desk: DeskBaseI }) {
	...
	const formik = useFormik<FlatDesk>({
		initialValues: {
			lat: desk.geo_location.lat,
			lng: desk.geo_location.lng,
			url: desk.geo_location.url,
			description: desk.description,
			Phone: desk.information.Phone.Number,
			AddressLine1: desk.information.Address.AddressLine[0],
			AddressLine2: desk.information.Address.AddressLine[1] || "",
			AddressLine3: desk.information.Address.AddressLine[2] || "",
			City: desk.information.Address.City,
			StateProvinceCode: desk.information.Address.StateProvinceCode,
			PostalCode: desk.information.Address.PostalCode,
			Name: desk.information.Name,
		},
